...
public class WordCount {
    public static void main(String[] args) throws Exception {
        ...
        String outputFile = "hdfs://localhost:9000/user/student/wordcount/spark_wordtrans";
        ...
        JavaPairRDD<Integer, String> counts = textFile
                .mapToPair((String s) -> {
                  String[] parts = s.split(" ");
                  String word = parts[0];
                  Integer count = Integer.parseInt(parts[1]);
                  return new Tuple2<Integer, String>(count, word);
                })
